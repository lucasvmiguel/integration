...
| Receive     | Receive is going to be used to assert if the Websocket server message returned what was expected. This field is optional as a Websocket server can never send a message back to the client. | &expect.Message{}       | false     | -       |
| Assertions  | Assertions that will run in test case                                                                                                                                                       | []assertion.Assertion{} | false     | -       |
...
| MessageType              | Message type used to send the call. It's based on Gorilla's message. Reference: https://pkg.go.dev/github.com/gorilla/websocket#pkg-constantstypes                                                                                              | websocket.PingMessage (9)     | false     | websocket.TextMessage (1) |
